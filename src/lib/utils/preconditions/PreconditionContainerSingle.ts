...
export interface SimplePreconditionSingleResolvableDetails {
	/**
	 * The name of the precondition to retrieve from {@link JinSoulClient.preconditions}.
	 * @since 2.0.0
	 */
...
/**
 * An {@link IPreconditionContainer} which runs a single precondition from {@link JinSoulClient.preconditions}.
 * @since 1.0.0
 */
